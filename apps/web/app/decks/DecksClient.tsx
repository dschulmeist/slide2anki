 ...
 *
 * This component is client-only because it depends on URL search params and triggers
...
export default function DecksClient() {
  ...
  const handleExport = useCallback(async (deckId: string) => {
    ...
    try {
      ...
      const downloadUrl = await api.getExportDownloadUrl(exportJob.export_id);
